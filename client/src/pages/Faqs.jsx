  ...
  return (
    <div className='bg-gray-50 transition-colors duration-300'>
      ...
      <div className="space-y-6">
        {/* What is SurveyLand */}
        <div className="bg-white rounded-lg p-6 shadow-sm transition-colors duration-300">
         ...
         <div className="p-6 max-w-5xl mx-auto bg-white rounded-lg shadow-md mb-8 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {formTypes.map((form, index) => (
              <button
                key={index}
                className="flex items-center gap-2 bg-cyan-100 text-black x-3 py-1 rounded-md shadow-sm hover:bg-cyan-200 n-800 transition"
              >
