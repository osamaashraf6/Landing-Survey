  ...
  return (
    <div className='bg-surface transition-colors duration-300'>
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl text-primary mb-4 mt-12">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">What is SurveyLand ?</h2>
         ...
         <div className="p-6 max-w-5xl mx-auto bg-card rounded-lg shadow-md mb-8 transition-colors duration-300">
          <h2 className="text-2xl font-bold text-accent mb-2">What can I do with SurveyLand ?</h2>
        ...
        {/* Why SurveyLand */}
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">Why SurveyLand?</h2>
          <p className="text-secondary leading-relaxed">
        ...
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">Do I need coding experience to create a form ?</h2>
          <p className="text-secondary leading-relaxed">
        ...
        {/* Is SurveyLand free */}
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">Is SurveyLand free ?</h2>
          <p className="text-secondary leading-relaxed">
            ...
            options, <span className="text-accent font-medium">visit our Pricing page</span>.
          </p>
        </div>

        {/* How to add forms to website */}
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">How do I add SurveyLand forms to my website ?</h2>
          <p className="text-secondary leading-relaxed">
        ...
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">How secure is my data with SurveyLand ?</h2>
          <p className="text-secondary leading-relaxed">
        ...
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">What happens to my data when I downgrade my account ?</h2>
          <p className="text-secondary leading-relaxed">
        ...
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">How does SurveyLand work ?</h2>
        ...
        <div className="bg-card rounded-lg p-6 shadow-sm transition-colors duration-300">
          <h2 className="text-xl font-semibold text-accent mb-3">What can I use SurveyLand for ?</h2>
          <p className="text-secondary leading-relaxed mb-4">
          ...
          <p className="text-secondary leading-relaxed">
            ...
            form data in <span className="text-accent font-medium">SurveyLand Tables</span>, manage responses in <span className="text-accent font-medium">SurveyLand Inbox</span>, and create fillable 
            PDF forms in <span className="text-accent font-medium">SurveyLand's PDF Editor</span>. It also offers more advanced data management tools, 
            like <span className="text-accent font-medium">SurveyLand Workflows</span> to automate workflows, <span className="text-accent font-medium">SurveyLand Report Builder</span> for detailed 
            analytics, and <span className="text-accent font-medium">SurveyLand Sign</span> to securely collect e-signatures. SurveyLand is a versatile 
