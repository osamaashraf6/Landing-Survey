    ...
    <section className=" pb-12">
      <div className="max-w-[1050px] mx-auto p-6 min-h-screen">
        ...
        <div className="space-y-6">
          ...
          >
            <h2 className="text-xl text-primary font-semibold text-accent mb-3">
              What is SurveyLand ?
            </h2>
          ...
          <div
            className={`p-6 pb-10 max-w-5xl mx-auto bg-card ${
              theme === "dark"
                ? "shadow-[0_-1px_10px_rgba(255,255,255,0.2)]"
                : "shadow-[0_-1px_10px_rgba(0,0,0,0.2)]"
            } rounded-lg  mb-8 transition-colors duration-300`}
          >
            <h2 className="text-xl text-primary font-bold text-accent mb-2">
              What can I do with SurveyLand ?
            </h2>
            <p className=" mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              {formTypes.map((form, index) => (
                <button
                  key={index}
                  className="flex items-center gap-2 bg-accent-light text-primary px-3 py-1 rounded-md shadow-lg hover:bg-accent-hover transition"
                >
          ...
          >
            <h2 className="text-xl text-primary font-semibold text-accent mb-3">Why SurveyLand?</h2>
            <p className=" leading-relaxed">
