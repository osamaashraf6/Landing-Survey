...
const Faqs = () => {
  const formTypes = [
    ...
    'Survey Templates', 'Signup Forms', 'Evaluation Forms',
    ...
    'Recommendation Forms', 'Poll Templates', 'Donation Forms',
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h2 className="text-xl font-semibold text-cyan-500 mb-3">What can I do with SurveyLand ?</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            SurveyLand enables you to create online forms, collect responses directly in your email, and 
            create fillable PDF forms. You can put together all types of forms, including:
          </p>
          
          {/* Form Types Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {formTypes.map((formType, index) => (
              <div key={index} className="bg-cyan-100 text-cyan-800 px-4 py-2 rounded-lg text-sm font-medium">
                {formType}
              </div>
            ))}
          </div>
